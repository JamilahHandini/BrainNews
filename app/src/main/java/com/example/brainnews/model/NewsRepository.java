...
import com.example.brainnews.rests.APIInterface;
...
public class NewsRepository {
    ...
    public void topHeadlines(String categories, String country,  String apiKey){
        apiInterface.getLatestNews(categories, country, apiKey)
                .enqueue(new Callback<ResponseModel>() {
                    @Override
                    public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                        if (response.body() != null) {
